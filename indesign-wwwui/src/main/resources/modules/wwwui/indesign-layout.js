indesign.createNs("indesign.layout");
console.log("Created indesign layout...");

// WebDraw Layout
//------------------------

indesign.layout.layoutRow = function(target) {
...
$(function() {
	...
	$(".indesign-layout-consumeRemainingBodyHeight").each(function(i,e) {
		...
		$(e).outerHeight(remainingHeight + heightAdjust);
	})
	;
